...
export function PrivacyPolicy() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 border border-hairline bg-surface-raised p-8">
      <h1 className="text-2xl font-bold text-ink">{t('privacyPolicyTitle')}</h1>
      <P>{t('effectiveDate')}</P>
      <Section title={t('privacyIntroTitle')}>
        <P>{t('privacyIntro')}</P>
      </Section>
      <Section title={t('infoCollectTitle')}>
        <h3 className="text-base font-medium text-ink">{t('infoProvidedTitle')}</h3>
        <List items={tList('infoProvidedList')} />
        <h3 className="text-base font-medium text-ink">{t('infoAutoTitle')}</h3>
      ...
      <Section title={t('contactUsTitle')}>
        ...
        <P>
          {t('contactLinkedIn')}{' '}
          <a href="https://www.linkedin.com/in/leon-melamud" target="_blank" rel="noreferrer" className="text-ink hover:text-ink">
            Leon Melamud
          </a>
        </P>
      </Section>
...
export function TermsOfService() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 border border-hairline bg-surface-raised p-8">
      <h1 className="text-2xl font-bold text-ink">{t('termsOfServiceTitle')}</h1>
      <P>{t('effectiveDate')}</P>
